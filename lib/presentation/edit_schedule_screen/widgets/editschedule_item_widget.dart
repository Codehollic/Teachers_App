...
class EditscheduleItemWidget extends StatelessWidget {
  EditscheduleItemWidget(this.editscheduleItemModelObj);

  EditscheduleItemModel editscheduleItemModelObj;

  var controller = Get.find<EditScheduleController>();
